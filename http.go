// Package didihe1988/http is a high level HTTP client.
//
...
//
// Please raise issues at https://github.com/didihe1988/http/issues.
//
// For lower level http implementations, see didihe1988/http/client.
package http
